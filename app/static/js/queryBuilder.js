export function buildQuery() {
    ...
    selectedNodes.forEach(node => {
        const { fields, tagKeys, tagValues, table } = getQueryComponents(node);
        const selectVals = getSelectValues(fields, tagKeys);
...
function getQueryComponents(node) {
    let fields = [];
    let tagKeys = [];
    let tagValues = [];
    let table = "";
...
function getSelectValues(fields, tagKeys) {
